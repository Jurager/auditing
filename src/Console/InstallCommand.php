...
namespace Jurager\Auditing\Console;
...
class InstallCommand extends Command
{
    ...
    protected function registerAuditingServiceProvider()
    {
        ...
        if (Str::contains($appConfig, 'Jurager\\Auditing\\AuditingServiceProvider::class')) {
            return;
        }

        file_put_contents(config_path('app.php'), str_replace(
            "{$namespace}\\Providers\EventServiceProvider::class,".PHP_EOL,
            "{$namespace}\\Providers\EventServiceProvider::class,".PHP_EOL."        Jurager\Auditing\AuditingServiceProvider::class,".PHP_EOL,
            $appConfig
        ));
    }
}

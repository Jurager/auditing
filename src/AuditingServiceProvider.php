...
use Jurager\Auditing\Contracts\Auditor;
use Jurager\Auditing\Console\AuditDriverCommand;
use Jurager\Auditing\Console\InstallCommand;
...
class AuditingServiceProvider extends ServiceProvider implements DeferrableProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton(Auditor::class, function ($app) {
            return new \Jurager\Auditing\Auditor($app);
        });
    }
